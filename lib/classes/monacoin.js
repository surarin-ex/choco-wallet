...
var Monacoin = /** @class */ (function () {
     ...
     */
    Monacoin.prototype._getAddressInfo = function (options) {
        return __awaiter(this, void 0, void 0, function () {
            var blockbook, allAddressData_1, paths, addresses, addressInfos, unspentSequence, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, blockbook.getAddressInfos(addresses)];
                    case 2:
                        ...
                        addressInfos.forEach(function (info) {
                            allAddressData_1.allAddressInfo.push(info);
                        });
     ...
     */
    Monacoin.prototype.getAllAddressInfo = function (options) {
        if (options === void 0) { options = {
            receivingAddressNum: GAP_LIMIT_RECEIVING,
            changeAddressNum: GAP_LIMIT_CHANGE
        }; }
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d, blockbook, allAddressData, unspentSequence, nextIndex, length_1, length_2, addressInfo;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._getAddressInfo({
                                blockbook: blockbook,
                    ...
                    case 4:
                        ...
                        nextIndex += length_1;
                        return [3 /*break*/, 3];
                    case 5: return [4 /*yield*/, this._getAddressInfo({
                            blockbook: blockbook,
                            allAddressData: allAddressData,
                            isChange: 1,
                            startIndex: 0,
                    ...
                    case 9:
                        addressInfo = [];
                        allAddressData.allAddressInfo.forEach(function (info, index) {
                            addressInfo.push({
