...
var Monacoin = /** @class */ (function () {
    ...
    Monacoin.prototype.updateAddressInfos = function (options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var _a, _b, _c, _d, _e, allAddressData, unspentSequence, nextIndex, length_1, length_2, addressInfos;
            return __generator(this, function (_f) {
                switch (_f.label) {
                    ...
                    case 2:
                        (_a = _f.sent(), allAddressData = _a.allAddressData, unspentSequence = _a.unspentSequence);
    ...
    Monacoin.prototype._getInputData = function (utxo, payment, isSegwit, redeemType) {
        ...
        return __assign({ hash: Buffer.from(Uint8Array.from(Buffer.from(utxo.txid, "hex")).reverse()), index: utxo.index }, mixin, mixin2);
    };
    /**
     ...
     */
    Monacoin.prototype._getOutputType = function (toAddress) {
        var _this = this;
        ...
        if (!returnType)
            throw new Error("Given address can't be classified");
        return returnType;
    };
    /**
    ...
    Monacoin.prototype._getOutputData = function (toAddress, amount) {
        var type = this._getOutputType(toAddress);
    ...
    Monacoin.prototype._selectUtxos = function (options) {
        ...
        var outputType = this._getOutputType(options.toAddress).toUpperCase();
        outputs[outputType]++;
        var changeType = this.addressType.slice(0, 4) === "P2SH" ? "P2SH" : this.addressType;
        var hasChange = false;
        options.utxos.forEach(function (utxo) {
            utxos.push(utxo);
            sumInput = sumInput.plus(utxo.amount);
            inputs[_this.addressType]++;
            // おつりアドレスなしでfeeを計算
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        if (options.feeRate < parseInt(this.minFeeRate) ||
