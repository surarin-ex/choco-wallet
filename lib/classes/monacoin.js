...
var Monacoin = /** @class */ (function () {
     ...
     */
    Monacoin.prototype.getOutputType = function (toAddress) {
        var _this = this;
    ...
    Monacoin.prototype._getOutputData = function (toAddress, amount) {
        var type = this.getOutputType(toAddress);
    ...
    Monacoin.prototype._selectUtxos = function (options) {
        ...
        var outputType = this.getOutputType(options.toAddress).toUpperCase();
        outputs[outputType]++;
