...
describe.only("Blockbook のユニットテスト", function () {
    ...
    describe("getAddressInfo() のユニットテスト", function () {
        ...
        it("取引実績のあるアドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blockbook.getAddressInfo("pTUe8n9ZGgXybNc9z4Xi1BcPAWeUpnqd4n")];
                    case 1:
                        addressInfo = _a.sent();
        ...
        it("取引実績のないアドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blockbook.getAddressInfo("pNdFKgQTK1PFeeBiBfbY9MpDouCbNRmAyt")];
                    case 1:
                        addressInfo = _a.sent();
                        chai_1.assert.deepEqual(addressInfo.page, 1);
                        chai_1.assert.deepEqual(addressInfo.totalPages, 1);
    ...
    describe("getAddressInfos() のユニットテスト", function () {
        ...
        it("複数のアドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blockbook.getAddressInfos(addresses)];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, blockbook.getTxInfo(txid)];
                    case 1:
                        txInfo = _a.sent();
    ...
    describe("getTxInfos() のユニットテスト", function () {
        var blockbook;
        var txids = [
            "8bc9ff20cc6a29b2db60e608225931fc3c04eaab09bebd9693f6fdd10f9542ff",
            "1b0f415d238a99f1d0334061ae25e89b198069f65d14fe967181aa9b0a961fe0"
        ...
        it("複数のトランザクション情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blockbook.getTxInfos(txids)];
                    case 1:
                        txInfos = _a.sent();
