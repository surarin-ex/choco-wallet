...
describe("Blockbook のユニットテスト", function () {
    describe("createBlockbook() のユニットテスト", function () { return __awaiter(_this, void 0, void 0, function () {
        var _this = this;
        return __generator(this, function (_a) {
            it("初期化できる", function () { return __awaiter(_this, void 0, void 0, function () {
                var blockbook, uris;
                return __generator(this, function (_a) {
                    switch (_a.label) {
            ...
            it("テストネットで初期化できる", function () { return __awaiter(_this, void 0, void 0, function () {
                var blockbook, uris;
                return __generator(this, function (_a) {
                    switch (_a.label) {
    ...
    describe("getAddressInfo() のユニットテスト", function () {
        var blockbook;
        before("testnetで初期化", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, blockbook_1.default("test", "Monacoin")];
                    case 1:
        ...
        it("取引実績のあるアドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var addressInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it("取引実績のないアドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var addressInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe("getAddressInfos() のユニットテスト", function () {
        ...
        it("複数のアドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe("getTxInfo() のユニットテスト", function () {
        ...
        it("トランザクション情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var txid, txInfo;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe("getBlockbookTxs() のユニットテスト", function () {
        ...
        it("複数のトランザクション情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var txInfos;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    describe("estimateBlockbookFeeRate() のユニットテスト", function () {
        var blockbook;
        before("mainnetで初期化", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it("手数料率を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var feeRate, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
    ...
    describe.only("broadcastTx() のユニットテスト", function () {
        var blockbook;
        before("testnetで初期化", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it("形式的に誤ったtxを送信した場合にエラーが返される", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("正しいトランザクションを送信するとresultが返され、blockbookからtx情報を参照するために利用できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var monacoin, summary, res, blockbookTx;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        monacoin = new __1.Monacoin("なめらか　からい　ひやけ　げきか　なにごと　かわら　こもち　おおや　おもう　こうかん　れいぎ　とそう", "test");
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, blockbook.broadcastTx(summary.txHex)];
                    case 2:
                        res = _a.sent();
                        chai_1.assert.deepEqual(res, summary.txid);
                        return [4 /*yield*/, blockbook.getBlockbookTx(res)];
                    case 3:
                        blockbookTx = _a.sent();
                        chai_1.assert.deepEqual(blockbookTx.txid, res);
                        chai_1.assert.deepEqual(blockbookTx.confirmations, 0);
                        chai_1.assert.deepEqual(blockbookTx.fees, summary.fees);
                        chai_1.assert.deepEqual(blockbookTx.hex, summary.txHex);
                        return [2 /*return*/];
                }
            });
        }); });
