...
describe.only("Monacoin のユニットテスト", function () {
    ...
    describe("estimateFeeRate() のユニットテスト", function () {
        ...
        it("150watanabe/byte以上の手数料が取得される", function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, monacoin.estimateFeeRate("slow")];
                    case 1:
                        feeRate = _a.sent();
        ...
        it("fast normal slow の順に手数料が小さくなる", function () { return __awaiter(_this, void 0, void 0, function () {
            var feeRate_fast, feeRate_normal, feeRate_slow;
            return __generator(this, function (_a) {
                switch (_a.label) {
