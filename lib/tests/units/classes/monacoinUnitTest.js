...
describe("Monacoin のユニットテスト", function () {
    ...
    describe("getAllAddressInfo() のユニットテスト", function () {
        var monacoin;
        before("インスタンス作成", function () {
            monacoin = new monacoin_1.default("むける　とかい　はんこ　ぐあい　きけんせい　ほそい　さゆう　そぼく　たいてい　さくら　とおか　はろうぃん", "test");
        });
        it("アドレス情報を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var addressInfo, initialAddress;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, monacoin.getAllAddressInfos({
                            receivingAddressNum: 14,
                            changeAddressNum: 6
                        })];
                    case 1:
                        addressInfo = _a.sent();
                        initialAddress = addressInfo.find(function (info) {
                        ...
                        chai_1.assert.isTrue(addressInfo.filter(function (info) {
    ...
    describe("getBalance() のユニットテスト", function () {
        var monacoin;
        before("インスタンス作成", function () {
            monacoin = new monacoin_1.default("むける　とかい　はんこ　ぐあい　きけんせい　ほそい　さゆう　そぼく　たいてい　さくら　とおか　はろうぃん", "test");
        });
        it("アドレス情報取得前に実行すると0を取得できる", function () {
            var balance = monacoin.getBalance();
            chai_1.assert.deepEqual(balance, "0");
        });
        it("アドレス情報取得後に実行すると正しい値を取得できる", function () { return __awaiter(_this, void 0, void 0, function () {
            var balance;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, monacoin.getAllAddressInfos()];
                    case 1:
                        _a.sent();
                        balance = monacoin.getBalance();
                        chai_1.assert.deepEqual(balance, "499950200");
                        return [2 /*return*/];
                }
            });
        }); });
