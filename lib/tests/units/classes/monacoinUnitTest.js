...
describe("Monacoin のユニットテスト", function () {
    ...
    describe("estimateFeeRate() のユニットテスト", function () {
        ...
        it("150watanabe/byte以上の手数料が取得される", function () { return __awaiter(_this, void 0, void 0, function () {
            var feeRate;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        it("fast normal slow min の順に手数料が小さくなる", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe("createUnsignedTx() のユニットテスト", function () {
        var monacoin;
        before("インスタンス作成", function () {
            monacoin = new monacoin_1.default("なめらか　からい　ひやけ　げきか　なにごと　かわら　こもち　おおや　おもう　こうかん　れいぎ　とそう", "test");
        });
        it("unsignedTxに含まれるデータの整合性が取れている", function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        it("amountにマイナスを指定するとエラーがthrowされる", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("amountに小数を指定するとエラーがthrowされる", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("amountに数字以外の文字列を指定するとエラーがthrowされる", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("amountに残高を超える金額を指定するとエラーがthrowされる", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("feeRateにminFeeRateを下回る金額を指定するとエラーがthrowされる", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_5;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("feeRateに小数を指定するとエラーがthrowされる", function () { return __awaiter(_this, void 0, void 0, function () {
            var err_6;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("送金額がインプットの合計と手数料の和と一致する場合におつりアドレスへの送金がなくなる", function () { return __awaiter(_this, void 0, void 0, function () {
    ...
    describe("signTx() のユニットテスト", function () {
        var monacoin;
        beforeEach("インスタンス作成", function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        monacoin = new monacoin_1.default("なめらか　からい　ひやけ　げきか　なにごと　かわら　こもち　おおや　おもう　こうかん　れいぎ　とそう", "test");
    ...
    describe("broadcastTx() のユニットテスト", function () {
        ...
        it("署名済みトランザクションがない場合、nullが返される", function () { return __awaiter(_this, void 0, void 0, function () {
            var txid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
        ...
        it("トランザクションを送信するとtxidが返される", function () { return __awaiter(_this, void 0, void 0, function () {
            var summary, txid;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
